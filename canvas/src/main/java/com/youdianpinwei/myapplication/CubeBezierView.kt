 ...
 */
class CubeBezierView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attributeSet, defStyleAttr) {
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        path.cubicTo(control1.x, control1.y, control2.x, control2.x, end.x, end.y)
