...
package com.ljj.imgselector.utils.croper;
 ...
 * 处理器:用来改变剪切窗口边界通过移动类型:Horizontal, Vertical, Corner or Center
 * <br>
 */
final class CropWindowMoveHandler {
     ...
     * 在精确触摸位置和精确处理位置之间持有的x和y偏移是活性的.因为我们在实际的处理(特别是mHandleRadius)中允许误差,所以可能有偏移.
     * 然而,当我们在处理拖动时,我们想要维持这些偏移以至于操作没有跳跃
     */
